...
Another way to keep track of data types is by their content (homogeneous, i.e. same type or different i.e. heterogeneous)


| dimension   | Homogeneous (same data type)  | Heterogeneous (different data types) |
|----|---------------|---------------|
